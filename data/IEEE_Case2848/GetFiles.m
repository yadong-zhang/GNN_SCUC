...
temp9 = zeros(1, num_gens);
bidx = ismember(gen_buses, zone9_thermals);
temp9(bidx) = 1;

temp10 = zeros(1, num_gens);
bidx = ismember(gen_buses, zone10_thermals);
temp10(bidx) = 1;

temp11 = zeros(1, num_gens);
bidx = ismember(gen_buses, zone11_thermals);
temp11(bidx) = 1;

temp12 = zeros(1, num_gens);
bidx = ismember(gen_buses, zone12_thermals);
temp12(bidx) = 1;

temp13 = zeros(1, num_gens);
bidx = ismember(gen_buses, zone13_thermals);
temp13(bidx) = 1;

temp14 = zeros(1, num_gens);
bidx = ismember(gen_buses, zone14_thermals);
temp14(bidx) = 1;

temp15 = zeros(1, num_gens);
bidx = ismember(gen_buses, zone15_thermals);
temp15(bidx) = 1;

temp16 = zeros(1, num_gens);
bidx = ismember(gen_buses, zone16_thermals);
temp16(bidx) = 1;

temp17 = zeros(1, num_loads);    % Dispatchable loads

mpc.reserves.zones(1, :) = cat(2, temp1, temp17);
mpc.reserves.zones(2, :) = cat(2, temp2, temp17);
mpc.reserves.zones(3, :) = cat(2, temp3, temp17);
mpc.reserves.zones(4, :) = cat(2, temp4, temp17);
mpc.reserves.zones(5, :) = cat(2, temp5, temp17);
mpc.reserves.zones(6, :) = cat(2, temp6, temp17);
mpc.reserves.zones(7, :) = cat(2, temp7, temp17);
mpc.reserves.zones(8, :) = cat(2, temp8, temp17);
mpc.reserves.zones(9, :) = cat(2, temp9, temp17);
mpc.reserves.zones(10, :) = cat(2, temp10, temp17);
mpc.reserves.zones(11, :) = cat(2, temp11, temp17);
mpc.reserves.zones(12, :) = cat(2, temp12, temp17);
mpc.reserves.zones(13, :) = cat(2, temp13, temp17);
mpc.reserves.zones(14, :) = cat(2, temp14, temp17);
mpc.reserves.zones(15, :) = cat(2, temp15, temp17);
mpc.reserves.zones(16, :) = cat(2, temp16, temp17);
